...
public class CharacterStat
{
    ...
    public virtual void AddModifier(StatModifier mod)
    {
        ...
        statModifiers.Sort(CompareModifierOrder);//Kolejność aplikacji mod(w zależności od mod)
    }
    ...
    {
        if (a.Order < b.Order)//a przed b
            return -1;
        else if (a.Order > b.Order)//a po b
            return 1;
    ...
    protected float CalculateFinalValue()
    {
        ...
        for (int i = 0; i < statModifiers.Count; i++)
        {
            ...
            else if (mod.Type == StatModType.PercentMult)//%more
            {
